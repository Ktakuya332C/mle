...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__eum

#else
#  define SWIG_init    init_eum

#endif
#define SWIG_name    "_eum"
...
SWIGINTERN PyObject *_wrap_optimal_basket(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:optimal_basket",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__vectorT_double_std__allocatorT_double_t_t,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "optimal_basket" "', argument " "1"" of type '" "std::vector< double,std::allocator< double > > &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "optimal_basket" "', argument " "1"" of type '" "std::vector< double,std::allocator< double > > &""'"); 
  }
  arg1 = reinterpret_cast< std::vector< double,std::allocator< double > > * >(argp1);
  result = (int)optimal_basket(*arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"optimal_basket", _wrap_optimal_basket, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
